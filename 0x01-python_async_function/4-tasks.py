#!/usr/bin/env python3
'''
Description:    Take the code from wait_n function and alter it into a new
                function task_wait_n. The code is nearly identical to wait_n
                except tasl_wait_random is being called
...
async def task_wait_n(n: int, max_delay: int = 10) -> List[float]:
    '''Execute task_wait_random and retuns sorted list of delay'''
    spawn_ls = []
    delay_ls = []
    for i in range(n):
